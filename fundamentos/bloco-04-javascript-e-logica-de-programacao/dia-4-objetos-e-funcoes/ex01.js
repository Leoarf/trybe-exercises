...
console.log('A jogadora ' + people.name + ' ' + people.lastName + ' ' + 'tem ' + people.age + ' ' + 'anos de idade')
...
console.log('A jogadora Marta Silva foi eleita a melhor do mundo por 6 vezes. ' + people.bestInTheWorld)
...
console.log('A jogadora possui ' + people.medals.golden + ' medalhas de ouro e ' + people.medals.silver + ' medalhas de prata');